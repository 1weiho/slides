...
// Cumulative GitHub stars per day, 2026-04-30 → 2026-08-08 (fetched 2026-08-08).
const STAR_SERIES = [
  2, 2, 41, 444, 900, 1344, 1757, 2257, 2574, 2733, 2855, 2995, 3090, 3165, 3212, 3234, 3283,
  3311, 3344, 3413, 3466, 3499, 3515, 3533, 3596, 3642, 3690, 3723, 3784, 3874, 3929, 3969,
  4232, 4550, 4618, 4665, 4688, 4703, 4732, 4758, 4778, 4999, 5135, 5204, 5244, 5281, 5305,
  5321, 5359, 5386, 5396, 5412, 5424, 5440, 5457, 5483, 5500, 5514, 5523, 5529, 5540, 5562,
  5572, 5585, 5593, 5596, 5604, 5630, 5644, 5653, 5671, 5685, 5703, 5708, 5725, 5738, 5753,
  5773, 5798, 5825, 5869, 5900, 5920, 5931, 5952, 5970, 5977, 5998, 6017, 6022, 6036, 6048,
  6054, 6061, 6075, 6084, 6090, 6098, 6102, 6105, 6105,
];
const STAR_TOTAL = 6105;
...
const SocialQr = ({
  ...
  >
    <img
      src={src}
      alt={handle}
      style={{ width: 224, height: 224, borderRadius: 20, background: '#ffffff' }}
    />
    <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
      {icon}
      <span style={{ fontFamily: monoFont, fontSize: 25, color: 'rgba(245, 245, 247, 0.85)' }}>
        {handle}
      </span>
    </div>
  </div>
  ...
  return (
    ...
    >
      ...
      <div style={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between' }}>
        <div className={rise} style={{ animationDelay: '700ms' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 24 }}>
            ...
            >
              <img
                src={avatar}
                alt="Yiwei Ho"
                style={{ width: 88, height: 88, objectFit: 'cover', objectPosition: '50% 50%' }}
              />
            </div>
            <div style={{ fontSize: 36, fontWeight: 500, color: 'var(--osd-text)' }}>Yiwei Ho</div>
          </div>
          <div style={{ display: 'flex', alignItems: 'center', gap: 14, marginTop: 36 }}>
            <svg width={30} height={30} viewBox="0 0 24 24">
              <circle cx={12} cy={12} r={9} fill="none" stroke="var(--osd-accent)" strokeWidth={1.8} />
              <ellipse cx={12} cy={12} rx={4} ry={9} fill="none" stroke="var(--osd-accent)" strokeWidth={1.8} />
              <path d="M3.5 12 H20.5" fill="none" stroke="var(--osd-accent)" strokeWidth={1.8} />
            </svg>
            <span style={{ fontFamily: monoFont, fontSize: 30, color: 'var(--osd-accent)' }}>
              1wei.dev
            </span>
          </div>
        </div>
